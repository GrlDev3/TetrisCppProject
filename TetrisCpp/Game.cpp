...
void Game::CreateNewPiece()
{
    ...
    mPosX = (BOARD_WIDTH / 2) + mPieces->GetXInitPos (mPiece, mRotation);
...
/// @brief Get a random integer between to numbers.
/// @param pA First number
/// @param pB Second number
/// @return Generated random number between first and second
int Game::GetRand(int pA, int pB)
{
    return rand() % (pB - pA + 1) + pA;
}

/// @brief Inital parameters of the game
void Game::InitGame()
{
    //Init random numbers
...
/// @brief Iterates through the piece matrix, and draws each block of the piece.
...
/// @brief Draw the two lines that delimit the board
void Game::DrawBoard ()
{
