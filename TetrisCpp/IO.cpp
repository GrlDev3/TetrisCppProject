...
/// @brief Draw a rectangle of a given color
/// @param pX1 Upper left corner of the rectangle
/// @param pY1 Upper left corner of the rectangle
/// @param pX2 Lower right corner of the rectangle
/// @param pY2 Lower right corner of the rectangle
/// @param pC Rectangle color 
...
/// @brief SDL Graphical Initialization
/// @return SDL Graphical Initialization
int IO::InitGraph()
{
